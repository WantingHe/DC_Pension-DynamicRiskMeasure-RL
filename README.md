...
This study adapts a risk-sensitive RL framework for optimal DC pension fund allocation decisions under mortality risk.
...
└── src/                             # Core implementation
    ...
    ├── hyperparams.py               # Initialization of all parameters
    ├── utils.py                     # Creation of colors and directories
